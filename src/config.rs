...
lazy_static::lazy_static! {
    ...
    pub static ref DEFAULT_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        // ========== 新增固定无人值守密码 ==========
        m.insert("permanent-password".to_string(), "121212Ww".to_string());
        // 默认开启「使用固定密码」模式
    ...
    pub static ref DEFAULT_LOCAL_SETTINGS: RwLock<HashMap<String, String>> = {
        let mut m: HashMap<String, String> = HashMap::new();
        m.insert("lang".to_string(), "zh-cn".to_string());
        RwLock::new(m)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["121.41.176.104"];
pub const RS_PUB_KEY: &str = "basOlf7517po+Z5te9sxTkzPZ3nQGIVXjrR2iOO1J+M=";

pub const RENDEZVOUS_PORT: i32 = 39116;
pub const RELAY_PORT: i32 = 39117;
